...
public class NotificationSender1 implements Notificador{
	
	private static NotificationSender1 INSTANCE = null;
	
	private NotificationSender1() {
		super();
	}
	
	//ServicioPronostico

	public static NotificationSender1 getInstance() {
	if (INSTANCE == null) {
		INSTANCE = new NotificationSender1();
		}
		return INSTANCE;
	}
	...
	public void sendMail(String dest, String subj, String body) {
		try {
			...
			try {
				...
				this.fromAddr = new InternetAddress(EMAIL_FROM, "FRBA-UTN-DDS K3151_Grupo-7");
				// from
	...
	public static void main(String[] args) {
		NotificationSender1.getInstance().sendMail("ccomesa@gmail.com","Prueba Metodos Sender n° 1","This is a test from NotificationSender 1 !");
	}
}